...
/*
	[TARGET  ] ЃЄdetach from parent, and move

	  [      ]
	[TARGET  ] ЃЄattach to the parent of the target, and move

	[        ]
	[TARGET  ] ЃЄattach to the parent of the target, and move

	[        ]
	  [TARGET] ЃЄattach to the parent of the target (previous tab), and move
*/
...
/*
	[TARGET  ] Ѓ«if the target has a parent, attach to it and and move

	  [TARGET] Ѓ«attach to the parent of the target, and move
	[        ]

	[TARGET  ] Ѓ«attach to the parent of the target, and move
	[        ]

	[TARGET  ] Ѓ«attach to the target, and move
	  [      ]
*/
...
/*
	[TARGET   ] Ѓ«attach dragged tab to the parent of the target as its next sibling
	  [DRAGGED]
*/
